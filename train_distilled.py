...
parser.add_argument('--save_dir', default='results_distill/', type=str)
# Knowledge distillation parameters
parser.add_argument('--temperature', default=5, type=float, help='temperature of KD')
parser.add_argument('--alpha', default=0.7, type=float, help='ratio for KL loss')
...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        precision, recall, f1_score, micro_f1, macro_f1, accuracy  = train(dataloaders["train"], model, model_ref1, model_ref2, criterion, optimizer, epoch, use_cuda)
        print(" Train : Precision : {} || Recall : {} || F1-Score : {} || Micro F1-Score : {} || Macro F1-Score : {} || Accuracy : {}".format(precision, recall, f1_score, micro_f1, macro_f1, accuracy))
        score += str(f1_score) + "\t"
        
        precision, recall, f1_score, micro_f1, macro_f1, accuracy = test(dataloaders["val"], model, criterion, epoch, use_cuda)
        print(" Valid : Precision : {} || Recall : {} || F1-Score : {} || Micro F1-Score : {} || Macro F1-Score : {} || Accuracy : {}".format(precision, recall, f1_score, micro_f1, macro_f1, accuracy))
        score += str(f1_score) + "\t ||"
        ...
        print(" Test : Precision : {} || Recall : {} || F1-Score : {} || Micro F1-Score : {} || Macro F1-Score : {} || Accuracy : {}".format(precision, recall, f1_score, micro_f1, macro_f1, accuracy))
        score += str(f1_score) + " - " + str(micro_f1) + " - " + str(macro_f1) + " - " + str(accuracy) + "\n"
        fopen2.write(score)
        fopen2.flush()
        
        fopen.write(" Test : Precision : {} || Recall : {} || F1-Score : {} || Micro F1-Score : {} || Macro F1-Score : {} || Accuracy : {}".format(precision, recall, f1_score, micro_f1, macro_f1, accuracy))
        fopen.flush()
    ...
    print("-"*100)
    precision, recall, f1_score, micro_f1, macro_f1, accuracy = test(dataloaders["val"], model, criterion, epoch, use_cuda)
    print("\n Test : Precision : {} || Recall : {} || F1-Score : {} || Micro F1-Score : {} || Macro F1-Score : {} || Accuracy : {}".format(precision, recall, f1_score, micro_f1, macro_f1, accuracy))
    
    fopen.write("-"*50)
    fopen.write("\n Test : Precision : {} || Recall : {} || F1-Score : {} || Micro F1-Score : {} || Macro F1-Score : {} || Accuracy : {}".format(precision, recall, f1_score, micro_f1, macro_f1, accuracy))
    fopen.close()
    
def train(trainloader, model, model_ref1, model_ref2, criterion, optimizer, epoch, use_cuda):
    model.train()
    model_ref1.eval()
    model_ref2.eval()
